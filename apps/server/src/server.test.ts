  ...
  Effect.gen(function* () {
    ...
    const runtime = ManagedRuntime.make(
      OtlpTracer.layer({
        ...
        resource: {
          serviceName: "nuecode-web",
          attributes: {
            "service.runtime": "nuecode-web",
...
it.layer(NodeServices.layer)("server router seam", (it) => {
  ...
  it.effect("serves the public environment descriptor without requiring auth", () =>
    Effect.gen(function* () {
      ...
      const url = yield* getHttpServerUrl("/.well-known/nuecode/environment");
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        assert.equal(record.resourceAttributes["service.name"], "nuecode-web");
  ...
  it.effect("enriches replayed project events with repository identity metadata", () =>
    Effect.gen(function* () {
      const repositoryIdentity = {
        canonicalKey: "github.com/t3tools/nuecode",
        locator: {
          source: "git-remote" as const,
          remoteName: "origin",
          remoteUrl: "git@github.com:T3Tools/nuecode.git",
        },
        displayName: "T3Tools/nuecode",
        provider: "github",
        owner: "T3Tools",
        name: "nuecode",
      };
      ...
      Effect.gen(function* () {
        ...
        const refreshStatus = vi.fn((_: string) =>
          Effect.succeed({
            ...
            hasOriginRemote: true,
            isDefaultBranch: false,
            branch: "nuecode/bootstrap-branch",
            hasWorkingTreeChanges: false,
            workingTree: {
              files: [],
              insertions: 0,
        ...
        assert.deepEqual(createWorktree.mock.calls[0]?.[0], {
          cwd: "/tmp/project",
          branch: "main",
          newBranch: "nuecode/bootstrap-branch",
          path: null,
        });
