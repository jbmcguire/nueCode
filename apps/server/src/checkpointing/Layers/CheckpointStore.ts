    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "nueCode",
          GIT_AUTHOR_EMAIL: "nuecode@users.noreply.github.com",
          GIT_COMMITTER_NAME: "nueCode",
          GIT_COMMITTER_EMAIL: "nuecode@users.noreply.github.com",
        };
