...
export const CLIENT_SETTINGS_STORAGE_KEY = "nuecode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "nuecode:saved-environment-registry:v1";
