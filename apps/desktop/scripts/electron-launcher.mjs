// This file mostly exists because we want dev mode to say "nueCode (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "nueCode (Dev)" : "nueCode (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.t3tools.nuecode.dev" : "com.t3tools.nuecode";
