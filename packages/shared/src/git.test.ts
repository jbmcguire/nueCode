...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:T3Tools/NueCode.git")).toBe(
      "github.com/t3tools/nuecode",
    );
    expect(normalizeGitRemoteUrl("https://github.com/T3Tools/NueCode.git")).toBe(
      "github.com/t3tools/nuecode",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/T3Tools/NueCode")).toBe(
      "github.com/t3tools/nuecode",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:T3Tools/platform/NueCode.git")).toBe(
      "gitlab.com/t3tools/platform/nuecode",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/T3Tools/platform/NueCode.git")).toBe(
      "gitlab.com/t3tools/platform/nuecode",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:T3Tools/NueCode.git"),
    ).toBe("T3Tools/NueCode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/T3Tools/NueCode.git"),
    ).toBe("T3Tools/NueCode");
  });
});
